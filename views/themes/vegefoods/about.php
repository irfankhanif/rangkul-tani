<div class="hero-wrap hero-bread"
    style="background-image: url('<?=base_url().'views/themes/'.theme_active().'/';?>images/rangkul.jpeg');">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-7 py-5 wrap-about pb-md-5 ftco-animate">
                <div class="heading-section-bold mb-4 mt-md-5">
                    <div class="ml-md-0">
                        <h2 class="mb-4">RANGKUL TANI BANYUMAS</h2>
                    </div>
                </div>
                <div class="pb-md-5">
                    ...
                    <p><a href="<?=base_url('public/product');?>" class="btn btn-primary">Lihat Produk</a></p>
                </div>
            </div>
        </div>
    </div>
