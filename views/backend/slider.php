...
function submit(x) {
    if (x == 'add') {
        ...
        $('[name="title"]').val("");
        $('[name="sub_title"]').val("");
        $('#modal_add .modal-title').html('Add New Slide')
        $('#image').show();
        $('#btn-tambah').show();
        $('#btn-ubah').hide();
    } else {
        $('#modal_add .modal-title').html('Edit Slide')
        $('#image').hide();
        $('#btn-tambah').hide();
        $('#btn-ubah').show();
        ...
        <div class="box-body table-responsive">
            <table id="example1" class="table table-bordered table-striped table-hover">
                ...
                <tbody>
					...
					// 	$param = 'publish';
					// }
					foreach($allslide as $s): 
					?>
                    <tr>
                        <td><?=$n++.'.';?></td>
                        <td><input type="checkbox" class="check" name="check_id[]" value="<?=$s->idslide;?>"></td>
                        <td><a href="#modal_add" data-toggle="modal" onclick="submit(<?=$s->idslide;?>)"><i
                                    class="fa fa-edit"></i></a>
                        </td>
                        <td>
                            <a href="#ganti_gambar" data-toggle="modal" onclick="ubah_gambar(<?=$s->idslide;?>)"><img
                                    src="<?=base_url('uploads/').$s->image;?>" alt="<?=$s->image;?>" width="100"
                                    height="100"></a>
                        </td>
                        <td><?=$s->title;?></td>
                        <td><?=$s->sub_title;?></td>
...
<div class="modal fade" id="modal_add" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?=base_url('plugin/addSlide');?>" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="title" placeholder="Judul Slide" required>
                    </div>
                    <div class="form-group">
                        <label>Sub Judul <span style="color:red;">*</span></label>
                        <input type="text" class="form-control" name="sub_title" placeholder="Sub Judul Slide" required>
                    </div>
